  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      const { data: heavyData, error } = await supabase
        .from('campaigns')
        .select(
          'background, milestones, problems, solutions, contact_email, contact_phone, campaign_address, pic1, pic2'
        )
        .eq('id', id)
        .single();
      ...
      if (error) {
        ...
        console.log('heavyData from supabase:', heavyData);
  ...
  <div className="container mx-auto px-4 py-10 max-w-6xl">
    ...
    {loading ? (
      ...
      <CampaignTabs
        ...
        milestones={extendedInfo?.milestones || undefined}
        contact={{

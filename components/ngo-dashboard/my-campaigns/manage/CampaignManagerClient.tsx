...
import { 
  ...
  Users, TrendingUp, ArrowLeft, XCircle, ExternalLink, Link as LinkIcon, 
  Loader2
} from "lucide-react";
import { Button } from "@/components/ui/button";
import UpdateMilestoneModal from "./UpdateMilestoneModal";

// Define your Block Explorer URL
               ...
               return (
                 ...
                 >
                   ...
                   <div className="absolute top-4 right-4">
                      ...
                      {isPendingProof && <span className="flex items-center gap-1 text-orange-600 bg-orange-50 px-2 py-1 rounded-full text-xs font-bold"><AlertCircle size={12}/> Cap Reached</span>}
                   </div>
